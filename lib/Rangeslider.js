  ...
  _createClass(Slider, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          onFocusClassName = _props.onFocusClassName;
      var onFocusValue = this.state.onFocusValue;
      ...
      if (labelKeys.length > 0) {
        ...
        try {
          for (var _iterator = labelKeys[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            var _className = onFocusValue.toString() === key ? (0, _classnames2.default)('rangeslider__label', onFocusClassName) : (0, _classnames2.default)('rangeslider__label');
